...
router.post('/users/me/avatar', upload.single('avatar'), async (req, res) => {  // upload.single('avatar') is middleware | avatar --> Key of value of files into body/form-data of postman
